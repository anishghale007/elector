...
import 'package:elector/controller/provincial%20controller/gandakiFPTP_stats_controller.dart';
...
class GandakiFptpStats extends StatefulWidget {
  GandakiFptpStats({Key? key}) : super(key: key);

  @override
  State<GandakiFptpStats> createState() => _GandakiFptpStatsState();
}

class _GandakiFptpStatsState extends State<GandakiFptpStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(gandakiFptpSortedProvider);
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomBarChart(
                          gandakiFPTPStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.gandakiFPTPStats,
  }) : super(key: key);

  final List<ProvincialFPTPStats> gandakiFPTPStats;
