...
import 'package:elector/controller/provincial%20controller/province1FPTP_stats_provider.dart';
...
class Province1FptpStats extends StatefulWidget {
  Province1FptpStats({Key? key}) : super(key: key);

  @override
  State<Province1FptpStats> createState() => _Province1FptpStatsState();
}

class _Province1FptpStatsState extends State<Province1FptpStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(province1FptpSortedProvider);
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomBarChart(
                          provincial1FPTPStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomPieChart(
                          province1FPTPStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.provincial1FPTPStats,
  }) : super(key: key);

  final List<ProvincialFPTPStats> provincial1FPTPStats;
...
class CustomPieChart extends StatelessWidget {
  const CustomPieChart({
    Key? key,
    required this.province1FPTPStats,
  }) : super(key: key);

  final List<ProvincialFPTPStats> province1FPTPStats;
