...
import 'package:elector/controller/provincial%20controller/sudurpaschimPR_stats_controller.dart';
...
class SudurpaschimPrStats extends StatefulWidget {
  SudurpaschimPrStats({Key? key}) : super(key: key);

  @override
  State<SudurpaschimPrStats> createState() => _SudurpaschimPrStatsState();
}

class _SudurpaschimPrStatsState extends State<SudurpaschimPrStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  final SudurpaschimPRStatsController sudurpaschimPRStatsController =
  Get.put(SudurpaschimPRStatsController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(sudurpaschimPrSortedProvider);
        ...
        return ListView(
          ...
          children: [
            SizedBox(height: 40),
            FutureBuilder(
              future: sudurpaschimPRStatsController.stats.value,
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomBarChart(
                          sudurpaschimPRStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.sudurpaschimPRStats,
  }) : super(key: key);

  final List<ProvincialPRStats> sudurpaschimPRStats;
