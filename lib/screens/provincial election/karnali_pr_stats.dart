...
import 'package:elector/controller/provincial%20controller/karnaliPR_stats_controller.dart';
...
class KarnaliPrStats extends StatefulWidget {
  KarnaliPrStats({Key? key}) : super(key: key);

  @override
  State<KarnaliPrStats> createState() => _KarnaliPrStatsState();
}

class _KarnaliPrStatsState extends State<KarnaliPrStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  final KarnaliPRStatsController karnaliPRStatsController =
  Get.put(KarnaliPRStatsController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(karnaliPrSortedProvider);
        ...
        return ListView(
          ...
          children: [
            SizedBox(height: 40),
            FutureBuilder(
              future: karnaliPRStatsController.stats.value,
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.karnaliPRStats,
  }) : super(key: key);

  final List<ProvincialPRStats> karnaliPRStats;
