...
import 'package:elector/controller/provincial%20controller/bagmatiFPTP_stats_controller.dart';
...
class BagmatiFptpStats extends StatefulWidget {
  BagmatiFptpStats({Key? key}) : super(key: key);

  @override
  State<BagmatiFptpStats> createState() => _BagmatiFptpStatsState();
}

class _BagmatiFptpStatsState extends State<BagmatiFptpStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(bagmatiFptpSortedProvider);
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomBarChart(
                          bagmatiFPTPStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.bagmatiFPTPStats,
  }) : super(key: key);

  final List<ProvincialFPTPStats> bagmatiFPTPStats;
