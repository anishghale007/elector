...
class Province1PrStats extends StatefulWidget {
  Province1PrStats({Key? key}) : super(key: key);

  @override
  State<Province1PrStats> createState() => _Province1PrStatsState();
}

class _Province1PrStatsState extends State<Province1PrStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  final Province1PRStatsController province1PRStatsController =
      Get.put(Province1PRStatsController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(province1PrSortedProvider);
        ...
        return ListView(
          ...
          children: [
            SizedBox(height: 40),
            FutureBuilder(
              future: province1PRStatsController.stats.value,
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomBarChart(
                          province1PRStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.province1PRStats,
  }) : super(key: key);

  final List<ProvincialPRStats> province1PRStats;
