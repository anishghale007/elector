...
import 'package:elector/controller/provincial%20controller/lumbiniFPTP_stats_controller.dart';
...
class LumbiniFptpStats extends StatefulWidget {
  LumbiniFptpStats({Key? key}) : super(key: key);

  @override
  State<LumbiniFptpStats> createState() => _LumbiniFptpStatsState();
}

class _LumbiniFptpStatsState extends State<LumbiniFptpStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(lumbiniFptpSortedProvider);
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomBarChart(
                          lumbiniFPTPStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.lumbiniFPTPStats,
  }) : super(key: key);

  final List<ProvincialFPTPStats> lumbiniFPTPStats;
