...
import 'package:elector/controller/provincial%20controller/lumbiniPR_stats_controller.dart';
...
class LumbiniPrStats extends StatefulWidget {
  LumbiniPrStats({Key? key}) : super(key: key);

  @override
  State<LumbiniPrStats> createState() => _LumbiniPrStatsState();
}

class _LumbiniPrStatsState extends State<LumbiniPrStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  final LumbiniPRStatsController lumbiniPRStatsController =
  Get.put(LumbiniPRStatsController());
      ...
      body: Consumer(builder: (context, ref, child) {
        ...
        return ListView(
          ...
          children: [
            SizedBox(height: 40),
            FutureBuilder(
              future: lumbiniPRStatsController.stats.value,
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.lumbiniPRStats,
  }) : super(key: key);

  final List<ProvincialPRStats> lumbiniPRStats;
