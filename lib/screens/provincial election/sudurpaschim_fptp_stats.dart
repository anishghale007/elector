...
import 'package:elector/controller/provincial%20controller/sudurpaschimFPTP_stats_controller.dart';
...
class SudurpaschimFptpStats extends StatefulWidget {
  SudurpaschimFptpStats({Key? key}) : super(key: key);

  @override
  State<SudurpaschimFptpStats> createState() => _SudurpaschimFptpStatsState();
}

class _SudurpaschimFptpStatsState extends State<SudurpaschimFptpStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(sudurpaschimFptpSortedProvider);
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomBarChart(
                          sudurpaschimFPTPStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.sudurpaschimFPTPStats,
  }) : super(key: key);

  final List<ProvincialFPTPStats> sudurpaschimFPTPStats;

  @override
  Widget build(BuildContext context) {
    List<charts.Series<ProvincialFPTPStats, String>> series = [
      charts.Series(
        id: 'Sudurpaschim FPTP',
        data: sudurpaschimFPTPStats,
