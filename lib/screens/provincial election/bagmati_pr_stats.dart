...
import 'package:elector/controller/provincial%20controller/bagmatiPR_stats_controller.dart';
import 'package:elector/controller/provincial%20controller/bagmati_provider.dart';
import 'package:elector/controller/provincial%20controller/province1PR_stats_controller.dart';
...
class BagmatiPrStats extends StatefulWidget {
  BagmatiPrStats({Key? key}) : super(key: key);

  @override
  State<BagmatiPrStats> createState() => _BagmatiPrStatsState();
}

class _BagmatiPrStatsState extends State<BagmatiPrStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  final BagmatiPRStatsController bagmatiPRStatsController =
  Get.put(BagmatiPRStatsController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(bagmatiPrSortedProvider);
        ...
        return ListView(
          ...
          children: [
            SizedBox(height: 40),
            FutureBuilder(
              future: bagmatiPRStatsController.stats.value,
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.bagmatiPRStats,
  }) : super(key: key);

  final List<ProvincialPRStats> bagmatiPRStats;
