...
import 'package:elector/controller/provincial%20controller/madheshFPTP_stats_provider.dart';
...
class MadheshFptpStats extends StatefulWidget {
  MadheshFptpStats({Key? key}) : super(key: key);

  @override
  State<MadheshFptpStats> createState() => _MadheshFptpStatsState();
}

class _MadheshFptpStatsState extends State<MadheshFptpStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(madheshFptpSortedProvider);
                    ...
                    child: Expanded(
                      child: Container(
                        ...
                        child: CustomBarChart(
                          madheshFPTPStats: snapshot.data!,
                        ),
                      ),
                    ),
                  );
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.madheshFPTPStats,
  }) : super(key: key);

  final List<ProvincialFPTPStats> madheshFPTPStats;
