...
import 'package:elector/controller/provincial%20controller/madheshPR_stats_controller.dart';
...
class MadheshPrStats extends StatefulWidget {
  MadheshPrStats({Key? key}) : super(key: key);

  @override
  State<MadheshPrStats> createState() => _MadheshPrStatsState();
}

class _MadheshPrStatsState extends State<MadheshPrStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  final MadheshPRStatsController madheshPRStatsController =
  Get.put(MadheshPRStatsController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(builder: (context, ref, child) {
        final sortedStream = ref.watch(madheshPrSortedProvider);
        ...
        return ListView(
          ...
          children: [
            SizedBox(height: 40),
            FutureBuilder(
              future: madheshPRStatsController.stats.value,
...
class CustomBarChart extends StatelessWidget {
  const CustomBarChart({
    Key? key,
    required this.madheshPRStats,
  }) : super(key: key);

  final List<ProvincialPRStats> madheshPRStats;
