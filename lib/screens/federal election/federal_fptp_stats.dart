...
class FederalFptpStats extends StatefulWidget {
  FederalFptpStats({Key? key}) : super(key: key);

  @override
  State<FederalFptpStats> createState() => _FederalFptpStatsState();
}

class _FederalFptpStatsState extends State<FederalFptpStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  String count() {
    print(voterTurnout);
    voterTurnout = int.parse(totalVotes!) / 400 * 100;
