...
import 'package:elector/controller/federalFPTP_stats_controller.dart';
import 'package:elector/controller/federalPR_stats_controller.dart';
...
class FederalPrStats extends StatefulWidget {
  FederalPrStats({Key? key}) : super(key: key);

  @override
  State<FederalPrStats> createState() => _FederalPrStatsState();
}

class _FederalPrStatsState extends State<FederalPrStats> {
  String? totalUsers;
  String? totalVotes;
  String voteTurnOut = "";
  double? voterTurnout;
  ...
  String count() {
    print(voterTurnout);
    voterTurnout = int.parse(totalVotes!) / 90 * 100;
